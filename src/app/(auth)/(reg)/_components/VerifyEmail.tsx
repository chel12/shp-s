					...
					<Container className="bg-white rounded-md p-6 max-w-145 mx-auto">
						<Section>
							...
							<Text className="text-base text-gray-700 mb-4 mt-0 leading-5">
								Спасибо, {username}, за регистрацию! Чтобы
								завершить процесс и активировать Ваш аккаунт,
								пожалуйста, подтвердите Ваш email, нажав на
								кнопку ниже.
							</Text>
							...
							<Text className="text-sm text-gray-600 mb-6 mt-0 leading-5">
								...
								24 часов. Если Вы не регистрировали аккаунт,
