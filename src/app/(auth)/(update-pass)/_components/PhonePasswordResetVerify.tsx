					...
					<form
						...
						<div>
							...
							<input
								...
								className="flex justify-center w-27.5 h-15 mx-auto text-center 
								px-4 py-3 border border-[#bfbfbf] rounded
						...
						<div className="flex flex-col gap-2">
							<button
								type="submit"
								disabled={loading}
								className={`${buttonStyles.active} rounded w-full 
								max-w-65 px-4 [&&]:h-10 cursor-pointer flex items-center 
