export const buttonStyles = {
	...
	active: 'bg-[#ff6633] text-white hover:shadow-(--shadow-article) active:shadow-(--shadow-button-active) flex items-center justify-center rounded cursor-pointer duration-300',
	inactive: 'bg-[#fcd5ba] text-[#ff6633] rounded',
};

export const formStyles = {
	label: 'text-base text-[#8f8f8f] block',
	input: 'w-65 h-10 py-2 px-4 text-main-text text-base border border-[#bfbfbf] rounded focus:border-[#70c05b] focus:shadow-(--shadow-button-default) focus:bg-white focus:outline-none caret-primary',
	loginLink:
