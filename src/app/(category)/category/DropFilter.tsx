	...
	return (
		<>
			<button
				...
				className="ml-3 xl:hidden h-8 p-2 w-32 rounded text-xs flex justify-center
			items-center duration-300 gap-x-2 bg-(--color-primary) text-white 
        ...
        `}>
				<div
					className="flex justify-between items-center mb-4 bg-[#f3f2f1] 
			h-11 rounded text-base font-bold p-2.5">
