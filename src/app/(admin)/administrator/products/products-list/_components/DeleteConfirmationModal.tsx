	...
	return (
		<div className="absolute inset-0 z-100 flex items-center justify-center
		 bg-[#fcd5bacc] min-h-screen text-main-text py-10 px-3 backdrop-blur-sm">
			<div className="relative bg-white rounded shadow-shadow-auth-form 
			max-h-[calc(100vh-80px)] w-full flex flex-col px-6">
				<div className="p-6">
					...
					<div className="flex items-start gap-2 text-sm text-red-600 mb-6">
						...
						/>
						<p>
							Это действие нельзя отменить! Товар будет полностью
							удален из системы.
						</p>
					</div>
					...
					<div className="flex gap-3 justify-end">
						...
						<button
							...
							className="px-4 py-2 bg-red-600 text-white rounded
							 hover:bg-red-700 disabled:opacity-50 flex items-center gap-2 cursor-pointer">
							{isDeleting ? (
								<>
									<Loader
										size={16}
