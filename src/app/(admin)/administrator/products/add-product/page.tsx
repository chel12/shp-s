...
export default function AddProductPage() {
	...
	//так как обычный id не правильно можно через _id, но логики много менять придётся
	...
	const uploadImage = async (
		...
		try {
			...
			//если всё ок верни тогда картинку
	...
	//проверка на акцию, если акция есть тогда заполнить скидку как обязательное поле
	...
	//закидывает из компонентов инпутов данные в стейт формы
		...
		<div className="container flex flex-col items-center px-4 py-8 text-main-text mx-auto">
			...
			<form
				...
				<button
					...
					className="w-full bg-primary hover:shadow-button-default 
					active:shadow-button-active text-white py-3 px-4 mb-5 
